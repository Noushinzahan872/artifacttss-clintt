  ...
  return (
    <div className="min-h-screen px-4 py-10">
      <motion.div
        ...
        className="max-w-6xl mx-auto shadow-2xl rounded-2xl overflow-hidden flex flex-col lg:flex-row lg:h-[600px]" 
      >
        {/* Image Section */}
        ...
        {/* Details Section */}
        <div className="lg:w-1/2 p-8 space-y-5 overflow-y-auto"> 
          ...
          <div>
            <button
              ...
              className={`btn ${liked ? 'btn-secondary' : 'btn-outline btn-info'}`}
            >
