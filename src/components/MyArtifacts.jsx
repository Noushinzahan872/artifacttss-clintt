...
const MyArtifacts = () => {
  ...
  return (
    ...
    <div className="px-4 sm:px-6 md:px-12 lg:px-24 py-12 overflow-x-auto">
      ...
      <div className="shadow-2xl rounded-2xl overflow-x-auto ring-1 ring-gray-100 dark:ring-gray-800">
            ...
            <tr>
              {[
                ...
                <th
                  key={title}
                  scope="col"
                  className="px-4 py-3 text-left text-xs font-semibold text-gray-700 dark:text-gray-200 uppercase tracking-wider whitespace-nowrap"
                >
                  {title}
                </th>
              ))}
          ...
          <tbody className=" divide-y divide-gray-200 dark:divide-gray-700">
            {artifacts.map((artifact, index) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-sm whitespace-nowrap">{artifact.type}</td>
                <td className="px-4 py-3 text-sm whitespace-nowrap">{artifact.createdAt}</td>
                <td className="px-4 py-3 text-sm whitespace-nowrap">{artifact.discoveredAt}</td>
                <td className="px-4 py-3 text-sm whitespace-nowrap">{artifact.discoveredBy}</td>
